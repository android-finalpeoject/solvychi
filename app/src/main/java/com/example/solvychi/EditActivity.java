       ...
       changemaill = getIntent().getStringExtra("email");
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DB.updateCourse(changemaill,inputusername.getText().toString(), inputchangemail.getText().toString(), inputchangepassword.getText().toString());
        ...
        backbtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent in = new Intent(EditActivity.this, loginActivity.class);
                startActivity(in);
                finish();
